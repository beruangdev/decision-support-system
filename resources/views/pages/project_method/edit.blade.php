        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                                    ...
                                    <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                                        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#method-result-tab" role="tablist">
                                            <li class="mr-2" role="presentation">
                                                <button class="inline-block p-4 rounded-t-lg border-b-2" id="comparision-matrix-tab" data-tabs-target="#comparision-matrix" type="button" role="tab" aria-controls="comparision-matrix" aria-selected="false">Comparison Matrix</button>
                                            </li>
                                            <li class="mr-2" role="presentation">
                                                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="calculate-weight-tab" data-tabs-target="#calculate-weight"
                                                    type="button" role="tab" aria-controls="calculate-weight" aria-selected="false">Weight</button>
                                            </li>
                                            <li class="mr-2" role="presentation">
                                                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="calculate-lambda-tab" data-tabs-target="#calculate-lambda"
                                                    type="button" role="tab" aria-controls="calculate-lambda" aria-selected="false">Lambda</button>
                                            </li>
                                            <li role="presentation">
                                                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="check-consistency-tab" data-tabs-target="#check-consistency"
                                                    type="button" role="tab" aria-controls="check-consistency" aria-selected="false">Check Consistency</button>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <form method="post" action="{{ route('project_method.update', ['project' => Route::input('project'), 'method' => $project_method->id]) }}" data-alternative_taxonomy_keys='@json($alternative_taxonomy_keys)'
                        x-data="editProjectMethod($el)" x-init="this.init" @submit.prevent="submit" data-old_value='@json($project_method)'>
                        @csrf
                        @method('PUT')
                                                ...
                                                <div class="flex flex-col mb-4 px-4 pt-2 pb-4 rounded-md border border-gray-300 dark:border-gray-700">
                                                    <div class="mb-3 grid grid-cols-12 gap-1">
                                                        ...
                                                        <div class="col-span-2 flex items-center gap-2">
                                                            <p x-text="weights[criteria.value].label" class="aspect-square flex items-center border justify-center  border-gray-300 text-xs font-semibold  dark:border-gray-700 rounded-md w-[2rem]"></p>

                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
                                                            </svg>

                                                            <p x-text="getRasioWeightLabel(1,criteria)" class="aspect-square flex items-center border text-xs font-semibold justify-center  border-gray-300 dark:border-gray-700 rounded-md w-[2rem]"></p>
                                                        </div>
