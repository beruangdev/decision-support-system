<div class="relative">
    ...
    <div id="dropdownDots" class="hidden z-10 w-44 bg-white  rounded divide-y divide-gray-100 shadow dark:bg-gray-840 dark:divide-gray-600">
        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
            <li>
                <x-dropdown-link href="{{ route('project_method.edit', $project_method->id) }}">
                    {{ __('Edit') }}
                </x-dropdown-link>
            </li>
            <li>
                <x-dropdown-link href="{{ route('project_method.destroy', $project_method->id) }}" class="button-delete-project_method">
                    {{ __('Delete') }}
                </x-dropdown-link>
            </li>
        </ul>
